...
{
private:
    std::unordered_multimap<unsigned int, unsigned int> orderkey_quant;
    std::unordered_multimap<unsigned int, unsigned int> custkey_orderkey;
    std::unordered_multimap<std::string, unsigned int> mktseg_custkey;
    // MKTDEGMENT -> CUSTOMERKEY -> ORDERKEY -> QUANTITY
